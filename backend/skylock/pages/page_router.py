...
html_handler = FastAPI(docs_url=None, redoc_url=None) #, dependencies=[Depends(global_limiter.limit(DEFAULT_RATE_LIMIT))]) 

html_handler.state.limiter = global_limiter # Użyj globalnego limitera
